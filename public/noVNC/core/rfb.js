...
import { EncryptionWrapper } from './encryptionWrapper.js';
...
export default class RFB extends EventTargetMixin {
    constructor(target, urlOrChannel, options) {
        ...
        this._encryptionWrapper = new EncryptionWrapper(options.shift || 3);
        this._encryptionWrapper.setEncryption(!!options.useBase62Caesar);
    ...
    _handleMessage() {
        ...
        if (this._encryptionWrapper.isEncrypted()) {
            const decryptedData = this._encryptionWrapper.decryptMessage(this._sock.rQ);
            this._sock.rQ = decryptedData;
            this._sock.rQlen = decryptedData.length;
        }
    ...
    // Modify _socketSend to use encryption
    _socketSend(data) {
        const encryptedData = this._encryptionWrapper.encryptMessage(data);
        this._sock.send(encryptedData);
    }
}
